...
using _MORE_DETAILS::is_default_printable_v;
using _MORE_DETAILS::printer_setting;
using _MORE_DETAILS::kind_of_printer_setting;
using _MORE_DETAILS::printer_adapter;
using _MORE_DETAILS::printer_setting_default;
using _MORE_DETAILS::printer_setting_noline;
using _MORE_DETAILS::fprint;
using _MORE_DETAILS::print;
using _MORE_DETAILS::nullostream;
using _MORE_DETAILS::nullout;
using _MORE_DETAILS::printer;
